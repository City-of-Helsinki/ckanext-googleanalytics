...
def google_analytics_resource_report(last):
    ...
    for resource in top_resources:
        resource.resource = toolkit.get_action('resource_show')({"ignore_auth": True}, {"id": resource.resource_id})
        resource.package = toolkit.get_action('package_show')({"ignore_auth": True}, {"id": resource.package_id})
